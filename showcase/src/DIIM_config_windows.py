...
DIIM_CORPORA_STORE_PATH = PROJECT_DIR + 'res\\data\\store\\corpora'
...
DIIM_DICT_STORE_PATH = PROJECT_DIR + 'res\\data\\store\\dict'
DIIM_DICT_ONTO_STORE_PATH = DIIM_DICT_STORE_PATH + '\\onto'
DIIM_DICT_IOT_STORE_PATH = DIIM_DICT_STORE_PATH + '\\iot'

DIIM_DF_STORE_PATH = PROJECT_DIR + 'res\\data\\store\\df'
DIIM_WV_STORE_PATH = PROJECT_DIR + 'res\\data\\store\\wv'
# similarities of iot with ontos
DIIM_SIM_STORE_PATH = PROJECT_DIR + 'res\\data\\store\\sim'
